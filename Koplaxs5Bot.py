...
cl.login(token="EmzPCrwVoovbWJpE6nbc.9MB7Qh7dpKe3Qw35V1JFVa.P0Hg8kzC1+c30pr70xwsLsMwy5uUFt92zgm1z3Ovspo=")
cl.loginResult()

ki = LINETCR.LINE() #Zorro
ki.login(token="EmTINlcYGKFb06nSC3W9.s05oLCw4hluK4FvdIaXnYq.EnZD/ech3XWa31x1+y94Y7V5e6VBovdNbldS9fflWLE=")
ki.loginResult()

kk = LINETCR.LINE() #Sanji
kk.login(token="EmyIcYFFmvIl2IAq54V9.TnW/8w0Ix4xncFkIjjNsEq.+EPjf5aSVSz+DDKajUZev7o9VXyHgG3fpTRMMqUSKrg=")
kk.loginResult()

kc = LINETCR.LINE() #Ussop
kc.login(token="EmIHRNdnkrwk4by6pdJ0.9lB+V7V5Oh1CAdwLCKV24a.xyIWwEw97ZkzY91AYU+r9zFD/uAEhZwlXg73kBUHe3g=")
kc.loginResult()

ks = LINETCR.LINE() #Chooper
ks.login(token="EmWi38qGz75MOkxvKrb0.71ww/DC65sQw0eHiHfOOua.a5pvUe9JxjGeXlAexwlQf+6kEh8pJ3dGyAeMuTmZGZg=")
ks.loginResult()
...
owner=["uc9cf626eb815a70d59c8e71f9fda4872"]
wait = {
    'contact':False,
    'autoJoin':True,
...
☆ PEKANBARU ☆
☆ BORN BETTER ☆
☆ ANDA DIAM KAMI SEGAN ☆


Minat? Silahkan PM!
Idline: http://line.me/ti/p/~eclipse.id""",
    "lang":"JP",
...
#--------------------------------
    ...
    #-------------- Add Friends ------------
              ...
              if msg.toType == 2:
                ...
                cl.sendText(msg.to,"Perintah Ditolak.")                
                cl.sendText(msg.to,"Hanya Owner Yang bisa Gunain Perintah ini.")
    #-------------=SC AllBio=---------------- Ganti Bio Semua Bot Format => Allbio: ANDA DIAM KAMI SEGAN
...
#-----------------------------------------------
         #----------------Fungsi Join Group Start-----------------------#
            elif msg.text in ["Kuy","Eclipse","Join kuy"]: #Panggil Semua Bot
              if msg.from_ in owner:
    ...
    #-------------Fungsi Leave Group Start---------------#
            elif msg.text in ["Bye ECL","Kabur all","Kaboor all"]: #Bot Ninggalin Group termasuk Bot Induk
              if msg.from_ in admin:
                if msg.toType == 2:
                    ginfo = cl.getGroup(msg.to)
                    try:
        ...
        #----------------Fungsi Banned Kick Target Finish----------------------#                
              ...
              if msg.from_ in owner:
                if msg.toType == 2:
                    ...
                    gs = kc.getGroup(msg.to)
                    gs = ks.getGroup(msg.to)
                    random.choice(KAC).sendText(msg.to,"Eh Bos Ini Room apaan?")
                    random.choice(KAC).sendText(msg.to,"Ratain aja lah\nRoom Ga Berguna..")
                    random.choice(KAC).sendText(msg.to,"Jangan Baper yah Bos;")
                    msg.contentType = 13
                    msg.contentMetadata = {'mid': mid}
                    random.choice(KAC).sendMessage(msg)
                    targets = []
...
#-----------------------------------------------
                ...
                kk.sendText(msg.to,"Jangan nakal yaa")
#-----------------------------------------------
...
#-----------------------------------------------
       ...
       #-------------Fungsi Respon Start---------------------#
              ...
              if msg.from_ in admin:
                ...
                ki.sendText(msg.to,"Tukang Sate On")
                kk.sendText(msg.to,"Tukang Tidur On")
                kc.sendText(msg.to,"Tukang Tukangan On")
      ...
      #-------------Fungsi Banned Send Contact Finish------------------#
              ...
              cl.sendText(msg.to,"OWNER ECLIPSE")
              cl.sendMessage(msg)
              cl.sendText(msg.to,"Mempersembahkan")
              cl.sendText(msg.to,"Itu Creator Kami Yang Tampan 😜")
                
      #-------------Fungsi Chat ----------------
            elif msg.text in ["Woy","woy","Woi","woi","bot","Bot"]:
                 quote = ['Kami Siap Tempur','Created:Andrii Setiawan\nIya Owner ','Sabar Pak Ketoilet Sebentar','iya pak','Grup Insyaalah Aman Komandan','Siap Komandan','Hadir Pak']
...
#---------------------
        ...
        if op.type == 15:
          if op.param2 in Bots:
             return
          random.choice(KAC).sendText(op.param1, "Semoga Diterima Amal Ibadahnya ")
